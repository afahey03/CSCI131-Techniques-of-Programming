...
public class Maze {
    ...
    public static boolean touchingAny(Box b, Box[] list, int n) {
        // TODO: Check each of the n Box objects in the list, to see if any of
        // them is touching Box b. If so, return true. Otherwise, if b is not
        // touching any of the boxes in the list, this function should return
        // false.
        for (int i = 0; i < n; i++) {
            if (list[i].touching(b)) {
                return true;
            }
        }
        return false;
