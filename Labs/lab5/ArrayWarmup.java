...
public class ArrayWarmup {
    ...
    public static void main(String[] args) {
        ...
        StdOut.print("First grade is: " + grades[1]); // Print out the first grade
        
        StdOut.println( );                // Leave one blank line

        StdOut.print("Last grade is: " + grades[numGrades - 1]);   // Print out the last grade
        
        StdOut.println( );                // Leave one blank line

        StdOut.print("Middle grade is: " + grades[numGrades / 2]); // Print out the grade in middle of list
