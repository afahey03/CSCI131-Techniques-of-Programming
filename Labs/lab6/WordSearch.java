...
public class WordSearch {
    public static void main(String[] args) {
        ...
        In wordSearchFile = new In("word-search.txt");

        // Read two integers, numRows and numCols, from the file.
        int numRows = 0, numCols = 0;

        numRows = wordSearchFile.readInt();
        numCols = wordSearchFile.readInt();
        ...
        for (int a = 0; a < numRows; a++) {
            for (int b = 0; b < numCols; b++ ) {
                grid[a][b] = wordSearchFile.readString().charAt(0);
            }
        }
        ...
        if (numFound > bestScore) {
            ...
            Out newHighScorer = new Out("high-score.txt");
            newHighScorer.println(name);
            newHighScorer.println(bestScore);
            newHighScorer.close();
        }
