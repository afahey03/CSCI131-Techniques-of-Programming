 ...
 *
 * Example: java Taxonomy, 1, t, short
 *************************************************************************/
        ...
        switch (wings) {
            ...
            case 1:
                ...
                switch (shape) {
                    ...
                    case 'T':
                    case 't':
                        StdOut.print("What antennae length?\n");
                        StdOut.print("  long - long antennae\n");
                        StdOut.print("  short - short antennae\n");
                        StdOut.print("Response: ");
                        ...
                        if (antennae.equals("long")) {
                            ...
                            StdOut.print("Order: Ephemeroptera\n");
